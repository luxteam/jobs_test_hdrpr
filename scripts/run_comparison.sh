...
python3.9 ../jobs_launcher/executeTests.py --test_filter $TESTS_FILTER --file_filter $FILE_FILTER --tests_root ../jobs --work_root ../Work/Results --work_dir HdRPR --scale_thumbnails 2.0 --cmd_variables Python $PYTHON Tool $TOOL ResPath "$CIS_TOOLS/../TestResources/hdrpr_autotests_assets" Engine $ENGINE Retries $RETRIES UpdateRefs $UPDATE_REFS
